...
namespace back_map.Migrations
{
    ...
    [Migration("20240129112931_add-update5")]
    partial class addupdate5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("back_map.Entity.AnnoucementInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("back_map.Entity.AnnoucementInfo", b =>
                {
                    ...
                    b.HasOne("back_map.Entity.MoreInfo", "MoreInfo")
                        .WithMany()
                        .HasForeignKey("MoreInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
